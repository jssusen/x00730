            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'dog_id', title:"宠物名称",formatter:function(value, row, index){
                                if (row.dog){
                        ...
                        {field: 'is_lock', title: __('Is_lock'), searchList: {"0":__('Is_lock 0'),"1":__('Is_lock 1')}, formatter: Table.api.formatter.toggle},
