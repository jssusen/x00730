...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-member_group_id" data-rule="required" data-source="member/group/index" class="form-control selectpage" name="row[member_group_id]" type="text" value="<?php echo htmlentities($row['member_group_id']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-error_login_time" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[error_login_time]" type="text" value="<?php echo $row['error_login_time']?datetime($row['error_login_time']):''; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Error_count'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-error_count" class="form-control" name="row[error_count]" type="number" value="<?php echo htmlentities($row['error_count']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Alipay'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-alipay" class="form-control" name="row[alipay]" type="text" value="<?php echo htmlentities($row['alipay']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-service_integrals" class="form-control" step="0.01" name="row[service_integrals]" type="number" value="<?php echo htmlentities($row['service_integrals']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Invest_integrals'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-invest_integrals" class="form-control" step="0.01" name="row[invest_integrals]" type="number" value="<?php echo htmlentities($row['invest_integrals']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-super_power" class="form-control" name="row[super_power]" type="number" value="<?php echo htmlentities($row['super_power']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Self_achievement'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-self_achievement" class="form-control" step="0.01" name="row[self_achievement]" type="number" value="<?php echo htmlentities($row['self_achievement']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Team_achievement'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-team_achievement" class="form-control" step="0.01" name="row[team_achievement]" type="number" value="<?php echo htmlentities($row['team_achievement']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Share_achievement'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-share_achievement" class="form-control" step="0.01" name="row[share_achievement]" type="number" value="<?php echo htmlentities($row['share_achievement']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-flow" class="form-control" step="0.01" name="row[flow]" type="number" value="<?php echo htmlentities($row['flow']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Total_income'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-total_income" class="form-control" step="0.01" name="row[total_income]" type="number" value="<?php echo htmlentities($row['total_income']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Online_time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-online_time" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[online_time]" type="text" value="<?php echo $row['online_time']?datetime($row['online_time']):''; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('First_sell'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-first_sell" class="form-control" name="row[first_sell]" type="number" value="<?php echo htmlentities($row['first_sell']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Effective'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-effective" class="form-control" name="row[effective]" type="number" value="<?php echo htmlentities($row['effective']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Share_income'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-share_income" class="form-control" step="0.01" name="row[share_income]" type="number" value="<?php echo htmlentities($row['share_income']); ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-robber" class="form-control selectpicker" name="row[robber]">
                <?php if(is_array($robberList) || $robberList instanceof \think\Collection || $robberList instanceof \think\Paginator): if( count($robberList)==0 ) : echo "" ;else: foreach($robberList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['robber'])?$row['robber']:explode(',',$row['robber']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
