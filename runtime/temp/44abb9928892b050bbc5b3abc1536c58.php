...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-price2" data-rule="required" class="form-control" step="0.01" name="row[price2]" type="number" value="0.00">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-sell_s_time" class="form-control datetimepicker" data-date-format=" HH:mm" data-use-current="true" name="row[sell_s_time]" type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-sell_e_time" class="form-control datetimepicker" data-date-format="HH:mm" data-use-current="true" name="row[sell_e_time]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Apply_fee'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-apply_fee" class="form-control" name="row[apply_fee]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Adopt_fee'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-adopt_fee" class="form-control" name="row[adopt_fee]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[rob_status]-<?php echo $key; ?>"><input id="row[rob_status]-<?php echo $key; ?>" name="row[rob_status]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"0"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
