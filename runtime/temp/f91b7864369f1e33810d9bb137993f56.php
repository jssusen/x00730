...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-new_category_id" data-rule="required" data-source="proclamation/New_category/index" class="form-control selectpage" name="row[new_category_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
