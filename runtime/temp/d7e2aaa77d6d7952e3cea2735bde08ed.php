<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"D:\phpstudy_pro\WWW\newInfo\public/../application/admin\view\index\login.html";i:1588765311;s:67:"D:\phpstudy_pro\WWW\newInfo\application\admin\view\common\meta.html";i:1588765311;s:69:"D:\phpstudy_pro\WWW\newInfo\application\admin\view\common\script.html";i:1588765311;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="login-screen">
                    <div class="well">
                        <div class="login-form">
                            <img id="profile-img" class="profile-img-card" src="/newInfo/public/assets/img/avatar.png" />
                            ...
                            <form action="" method="post" id="login-form">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon" style="padding:0;border:none;cursor:pointer;">
                                        <img src="<?php echo rtrim('/newInfo/public/', '/'); ?>/index.php?s=/captcha" width="100" height="30" onclick="this.src = '<?php echo rtrim('/newInfo/public/', '/'); ?>/index.php?s=/captcha&r=' + Math.random();"/>
                                    </span>
                                </div>
                                <?php endif; ?>
