<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"G:\phpstudy\WWW\kj\public/../application/admin\view\dog\dog\edit.html";i:1596435173;s:61:"G:\phpstudy\WWW\kj\application\admin\view\layout\default.html";i:1588765311;s:58:"G:\phpstudy\WWW\kj\application\admin\view\common\meta.html";i:1588765311;s:60:"G:\phpstudy\WWW\kj\application\admin\view\common\script.html";i:1588765311;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-period_day" data-rule="required"
                   class="form-control"
                   name="row[period_day]"
                   type="number"  value="<?php echo htmlentities($row['period_day']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-gains" data-rule="required"
                   class="form-control"
                   name="row[gains]"
                   type="number"  value="<?php echo htmlentities($row['gains']); ?>">
        </div>
    </div>
