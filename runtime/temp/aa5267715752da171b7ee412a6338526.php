<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"G:\phpstudy\WWW\x00730\public/../application/admin\view\dog\dog\add.html";i:1596434148;s:65:"G:\phpstudy\WWW\x00730\application\admin\view\layout\default.html";i:1588765312;s:62:"G:\phpstudy\WWW\x00730\application\admin\view\common\meta.html";i:1588765312;s:64:"G:\phpstudy\WWW\x00730\application\admin\view\common\script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">矿机类型</label>
        <div class="col-xs-12 col-sm-8">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-period_day"
                   data-rule="required"
                   class="form-control"
                   name="row[period_day]" type="number" value="1">
        </div>
    </div>


    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">利润收益</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-gains" class="form-control" name="row[gains]"  type="number" value="">
        </div>
    </div>


    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">产品<?php echo __('Remark'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
