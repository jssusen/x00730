...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-iconimage" class="form-control" size="50" name="row[iconimage]" type="text" value="<?php echo htmlentities($row['iconimage']); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-day_rob_number" class="form-control" name="row[day_rob_number]" type="number" value="<?php echo htmlentities($row['day_rob_number']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-share_bonus" class="form-control" name="row[share_bonus]" type="text" value="<?php echo htmlentities($row['share_bonus']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Team_bonus'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-team_bonus" class="form-control" name="row[team_bonus]" type="text" value="<?php echo htmlentities($row['team_bonus']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Team_layer'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-team_layer" class="form-control" name="row[team_layer]" type="number" value="<?php echo htmlentities($row['team_layer']); ?>">
        </div>
    </div>
