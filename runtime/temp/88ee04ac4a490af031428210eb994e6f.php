...
<script type="text/javascript">
                ...
                <div id="content">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <?php endif; ?>
                            <div class="content">
                                <form id="create_match-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-dog"
                   data-rule="required"
                   class="form-control" name="row[dog]"
                   type="text" value="">
        </div>
    </div>
