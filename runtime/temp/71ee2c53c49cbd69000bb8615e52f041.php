<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"G:\phpstudy\WWW\x00730\public/../application/common\view\tpl\dispatch_jump.tpl";i:1595416652;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="system-message <?php echo $codeText; ?>">
    <div class="image">
        <img src="/x00730/public/assets/img/<?php echo $codeText; ?>.svg" alt="" width="150" />
    </div>
    <h1><?php echo $msg; ?></h1>
    <?php if($url): ?>
        <p class="jump">
