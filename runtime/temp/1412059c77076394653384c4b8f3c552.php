<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"G:\phpstudy\WWW\kj\public/../application/admin\view\history\withdrawal\add.html";i:1596524938;s:61:"G:\phpstudy\WWW\kj\application\admin\view\layout\default.html";i:1588765311;s:58:"G:\phpstudy\WWW\kj\application\admin\view\common\meta.html";i:1588765311;s:60:"G:\phpstudy\WWW\kj\application\admin\view\common\script.html";i:1588765311;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-procedures_money" data-rule="required" class="form-control" step="0.01" name="row[procedures_money]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Really_money'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-really_money" data-rule="required" class="form-control" step="0.01" name="row[really_money]" type="number">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-money_position" data-rule="required" class="form-control" name="row[money_position]" type="text">
        </div>
    </div>
