...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-apply_fee" class="form-control" step="0.01" name="row[apply_fee]" type="number" value="0.00">
        </div>
    </div>
    <div class="form-group">
