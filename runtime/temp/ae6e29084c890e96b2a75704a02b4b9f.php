<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"G:\phpstudy\WWW\kj\public/../application/admin\view\proclamation\news\add.html";i:1595817151;s:61:"G:\phpstudy\WWW\kj\application\admin\view\layout\default.html";i:1588765311;s:58:"G:\phpstudy\WWW\kj\application\admin\view\common\meta.html";i:1588765311;s:60:"G:\phpstudy\WWW\kj\application\admin\view\common\script.html";i:1588765311;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('New_category_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-new_category_id"
                   data-rule="required"
                   data-source="proclamation/New_category/index"
                   class="form-control selectpage" name="row[new_category_id]"
                   type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Titile'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-titile" data-rule="required" class="form-control" name="row[titile]" type="text">
        </div>
    </div>
    <div class="form-group">
