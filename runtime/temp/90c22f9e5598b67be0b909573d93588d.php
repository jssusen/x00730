<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"G:\phpstudy\WWW\x00730\public/../application/admin\view\history\invest\edit.html";i:1596448644;s:65:"G:\phpstudy\WWW\x00730\application\admin\view\layout\default.html";i:1588765312;s:62:"G:\phpstudy\WWW\x00730\application\admin\view\common\meta.html";i:1588765312;s:64:"G:\phpstudy\WWW\x00730\application\admin\view\common\script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group" style="display: none">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-uid"
                   ...
                   name="row[uid]" type="number"
                   value="<?php echo htmlentities($row['uid']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Money'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-money" readonly data-rule="required" class="form-control" step="0.01" name="row[money]" type="number" value="<?php echo htmlentities($row['money']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-remark" readonly class="form-control" name="row[remark]" type="text" value="<?php echo htmlentities($row['remark']); ?>">
        </div>
    </div>
