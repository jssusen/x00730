...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-sell_s_time"
                   data-rule="required"
                   class="form-control datetimepicker"
                   data-date-format="HH:mm"
                   data-use-current="true"
                   name="row[sell_s_time]" type="text" value="<?php echo date('H:i'); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-sell_e_time"
                   class="form-control datetimepicker"
                   data-date-format="HH:mm"
                   data-use-current="true"
                   name="row[sell_e_time]"
                   type="text" value="<?php echo date('H:i'); ?>">
        </div>
    </div>
